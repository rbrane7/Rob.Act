...
namespace Rob.Act
{
	public static class Translation
	{
		...
		{
			if( Path.Persistent && System.IO.Path.ChangeExtension(file,Path.Filext) is string p && file!=p && System.IO.File.Exists(p) ) return null ; // we prefer .path files over all serialization forms
