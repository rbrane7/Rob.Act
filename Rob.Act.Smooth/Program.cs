...
namespace Rob.Act
{
	...
	class Program
	{
		...
		static Oper Operation = (Configer.AppSettings["Combining"]!=null?Oper.Combi:Oper.Merge)|(Configer.AppSettings["Smoothing"]!=null?Oper.Smooth:Oper.Merge)|(Configer.AppSettings["Trimming"]!=null?Oper.Trim:Oper.Merge)|(Configer.AppSettings["Revaling"]!=null?Oper.Relat:Oper.Merge) ;
